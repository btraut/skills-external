...
PROJECT_ENV_CODEX=".codex/last30days.env"
PROJECT_ENV_CLAUDE=".claude/last30days.env"
...
CONFIG_FILE=""
if [[ -f "$PROJECT_ENV_CODEX" ]]; then
  CONFIG_FILE="$PROJECT_ENV_CODEX"
  check_perms "$PROJECT_ENV_CODEX"
elif [[ -f "$PROJECT_ENV_CLAUDE" ]]; then
  CONFIG_FILE="$PROJECT_ENV_CLAUDE"
  check_perms "$PROJECT_ENV_CLAUDE"
